...
<div class="container">
	...
	<div>
		<form method="post">
			...
			<div>ID : <input type="text" name="mid" class="form-control mb-2" placeholder="ID를 입력하세요"></div>
			<div class="mb-2">성별 :
				<input type="radio" name="gender" value="남자" checked> 남자 &nbsp;
				<input type="radio" name="gender" value="여자"> 여자
			</div>
			<div>주소 : <input type="text" name="address" value="청주" class="form-control mb-2" placeholder="주소를 입력하세요" required></div>
			<div>직업 : <input type="text" name="job" class="form-control mb-2" placeholder="직업을 입력하세요"></div>
